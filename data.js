...
// ------------------------- Buy -------------------------
export async function buyIt(event, email) {
    console.log(event.peopleBoughtIt, email);
    event.peopleBoughtIt.push(email);
    const result = await updateById(event.objectId, { peopleBoughtIt: event.peopleBoughtIt })
